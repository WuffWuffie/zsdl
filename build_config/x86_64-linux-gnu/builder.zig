...
pub fn build(b: *std.Build, sdl_dep: *std.Build.Dependency, mod: *std.Build.Module) void {
    mod.addIncludePath(b.path("build_deps/x86_64-linux-gnu/include-config-release/build_config"));
    mod.addIncludePath(sdl_dep.path("include"));
    mod.addIncludePath(sdl_dep.path("src"));

    mod.addCMacro("SDL_BUILD_MAJOR_VERSION", "3");
    mod.addCMacro("SDL_BUILD_MICRO_VERSION", "0");
    mod.addCMacro("SDL_BUILD_MINOR_VERSION", "5");
    ...
    mod.addCSourceFiles(.{
        .root = b.path("build_deps/x86_64-linux-gnu"),
        .files = &.{
